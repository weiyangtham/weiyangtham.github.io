...
theme_nber = function(base_size = 11, base_family = ""){
  ...
  theme_grey(base_size = base_size, base_family = base_family) %+replace%
        theme(
          # line = element_line(colour = "#0079C2", size = 0.5, linetype = 1, lineend = "butt"),
...
p + theme_nber() + 
  labs(title = "Employment and Exposure to Robots", 
       subtitle = "Change in Private Employment", 
       caption = "Source: Gapminder")  + scale_color_tableau()
```
